...
export default class Portal extends React.Component {
  ...
  onClickAway = (event) => {
    ...
    if ((event.target !== el && event.target === window) ||
      (document.documentElement.contains(event.target) && !this.isDescendant(el, event.target))) {
  ...
  renderPortal() {
    ...
    this.portalElement = unstable_renderSubtreeIntoContainer(this, portalElement, this.portal);
